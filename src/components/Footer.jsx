...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-100 p-20 flex mt-20">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h2 className="text-[6vw] leading-none uppercase -mb-8 font-semibold">
            Eye-
          </h2>
          <h2 className="text-[8vw] leading-none uppercase -mb-8 font-semibold">
            Opening
          </h2>
        </div>
        <svg
      ...
      <div className="w-1/2">
        ...
        <div className="dets mt-20">
            <a href="" className="text-xl font-light block">Facebook</a>
            <a href="" className="text-xl font-light block">Instagram</a>
            <a href="" className="text-xl font-light block">Twitter</a>
        </div>
          </div>
    </div>
  );
